...
package A0B.STM32F407.SVD.RCC is
   pragma Preelaborate;
   ...
   type AHB2RSTR_Register is record
      ...
      --  unspecified
      Reserved_1_5  : A0B.Types.SVD.UInt5 := 16#0#;
   ...
   type AHB1ENR_Register is record
      ...
      CRCEN          : Boolean := False;
      --  unspecified
      Reserved_13_17 : A0B.Types.SVD.UInt5 := 16#0#;
   ...
   type AHB2LPENR_Register is record
      ...
      --  unspecified
      Reserved_1_5  : A0B.Types.SVD.UInt5 := 16#18#;
