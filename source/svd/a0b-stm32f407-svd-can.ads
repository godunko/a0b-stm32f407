...
package A0B.STM32F407.SVD.CAN is
   pragma Preelaborate;
   ...
   type MCR_Register is record
      ...
      TTCM           : Boolean := False;
      --  unspecified
      Reserved_8_14  : A0B.Types.SVD.UInt7 := 16#0#;
      --  RESET
      RESET          : Boolean := False;
      --  DBF
      DBF            : Boolean := True;
   ...
   subtype TSR_CODE_Field is A0B.Types.SVD.UInt2;
   ...
   type TSR_Register is record
      ...
      TERR1          : Boolean := False;
      --  unspecified
      Reserved_12_14 : A0B.Types.SVD.UInt3 := 16#0#;
      --  ABRQ1
      ABRQ1          : Boolean := False;
      --  RQCP2
      RQCP2          : Boolean := False;
   ...
   subtype RF0R_FMP0_Field is A0B.Types.SVD.UInt2;
   ...
   subtype RF1R_FMP1_Field is A0B.Types.SVD.UInt2;
   ...
   subtype ESR_LEC_Field is A0B.Types.SVD.UInt3;
   subtype ESR_TEC_Field is A0B.Types.SVD.Byte;
   subtype ESR_REC_Field is A0B.Types.SVD.Byte;
   ...
   subtype BTR_BRP_Field is A0B.Types.SVD.UInt10;
   subtype BTR_TS1_Field is A0B.Types.SVD.UInt4;
   subtype BTR_TS2_Field is A0B.Types.SVD.UInt3;
   subtype BTR_SJW_Field is A0B.Types.SVD.UInt2;
   ...
   subtype TI0R_EXID_Field is A0B.Types.SVD.UInt18;
   subtype TI0R_STID_Field is A0B.Types.SVD.UInt11;
   ...
   subtype TDT0R_DLC_Field is A0B.Types.SVD.UInt4;
   subtype TDT0R_TIME_Field is A0B.Types.SVD.UInt16;
   ...
   subtype TDL0R_DATA_Element is A0B.Types.SVD.Byte;
   ...
   subtype TDH0R_DATA_Element is A0B.Types.SVD.Byte;
   ...
   subtype TI1R_EXID_Field is A0B.Types.SVD.UInt18;
   subtype TI1R_STID_Field is A0B.Types.SVD.UInt11;
   ...
   subtype TDT1R_DLC_Field is A0B.Types.SVD.UInt4;
   subtype TDT1R_TIME_Field is A0B.Types.SVD.UInt16;
   ...
   subtype TDL1R_DATA_Element is A0B.Types.SVD.Byte;
   ...
   subtype TDH1R_DATA_Element is A0B.Types.SVD.Byte;
   ...
   subtype TI2R_EXID_Field is A0B.Types.SVD.UInt18;
   subtype TI2R_STID_Field is A0B.Types.SVD.UInt11;
   ...
   subtype TDT2R_DLC_Field is A0B.Types.SVD.UInt4;
   subtype TDT2R_TIME_Field is A0B.Types.SVD.UInt16;
   ...
   subtype TDL2R_DATA_Element is A0B.Types.SVD.Byte;
   ...
   subtype TDH2R_DATA_Element is A0B.Types.SVD.Byte;
   ...
   subtype RI0R_EXID_Field is A0B.Types.SVD.UInt18;
   subtype RI0R_STID_Field is A0B.Types.SVD.UInt11;
   ...
   subtype RDT0R_DLC_Field is A0B.Types.SVD.UInt4;
   subtype RDT0R_FMI_Field is A0B.Types.SVD.Byte;
   subtype RDT0R_TIME_Field is A0B.Types.SVD.UInt16;
   ...
   subtype RDL0R_DATA_Element is A0B.Types.SVD.Byte;
   ...
   subtype RDH0R_DATA_Element is A0B.Types.SVD.Byte;
   ...
   subtype RI1R_EXID_Field is A0B.Types.SVD.UInt18;
   subtype RI1R_STID_Field is A0B.Types.SVD.UInt11;
   ...
   subtype RDT1R_DLC_Field is A0B.Types.SVD.UInt4;
   subtype RDT1R_FMI_Field is A0B.Types.SVD.Byte;
   subtype RDT1R_TIME_Field is A0B.Types.SVD.UInt16;
   ...
   subtype RDL1R_DATA_Element is A0B.Types.SVD.Byte;
   ...
   subtype RDH1R_DATA_Element is A0B.Types.SVD.Byte;
   ...
   subtype FMR_CAN2SB_Field is A0B.Types.SVD.UInt6;
   ...
   type FMR_Register is record
      ...
      --  unspecified
      Reserved_14_31 : A0B.Types.SVD.UInt18 := 16#A870#;
   end record
     with Object_Size => 32, Bit_Order => System.Low_Order_First;
