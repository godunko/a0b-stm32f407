...
package A0B.SVD.STM32F407.USB_OTG_HS is
   ...
   subtype OTG_HS_GRXSTSR_Peripheral_EPNUM_Field is A0B.Types.SVD.UInt4;
   subtype OTG_HS_GRXSTSR_Peripheral_BCNT_Field is A0B.Types.SVD.UInt11;
   subtype OTG_HS_GRXSTSR_Peripheral_DPID_Field is A0B.Types.SVD.UInt2;
   subtype OTG_HS_GRXSTSR_Peripheral_PKTSTS_Field is A0B.Types.SVD.UInt4;
   subtype OTG_HS_GRXSTSR_Peripheral_FRMNUM_Field is A0B.Types.SVD.UInt4;
   ...
   subtype OTG_HS_GRXSTSP_Peripheral_EPNUM_Field is A0B.Types.SVD.UInt4;
   subtype OTG_HS_GRXSTSP_Peripheral_BCNT_Field is A0B.Types.SVD.UInt11;
   subtype OTG_HS_GRXSTSP_Peripheral_DPID_Field is A0B.Types.SVD.UInt2;
   subtype OTG_HS_GRXSTSP_Peripheral_PKTSTS_Field is A0B.Types.SVD.UInt4;
   subtype OTG_HS_GRXSTSP_Peripheral_FRMNUM_Field is A0B.Types.SVD.UInt4;
   ...
   subtype OTG_HS_GNPTXFSIZ_Host_NPTXFSA_Field is A0B.Types.SVD.UInt16;
   subtype OTG_HS_GNPTXFSIZ_Host_NPTXFD_Field is A0B.Types.SVD.UInt16;
   ...
   subtype OTG_HS_TX0FSIZ_Peripheral_TX0FSA_Field is A0B.Types.SVD.UInt16;
   subtype OTG_HS_TX0FSIZ_Peripheral_TX0FD_Field is A0B.Types.SVD.UInt16;
   ...
   subtype OTG_HS_HCCHAR_MCNT_Field is A0B.Types.SVD.UInt2;
   ...
   type OTG_HS_HCCHAR_Register is record
      ...
      MCNT           : OTG_HS_HCCHAR_MCNT_Field := 16#0#;
      --  Device address
   ...
   type OTG_HS_HCINT0_Register is record
      --  Transfer completed
      XFRC           : Boolean := False;
      --  Channel halted
      CHH            : Boolean := False;
   ...
   for OTG_HS_HCINT0_Register use record
      XFRC           at 0 range 0 .. 0;
      CHH            at 0 range 1 .. 1;
      Reserved_2_2   at 0 range 2 .. 2;
   ...
   for OTG_HS_DEVICE_Peripheral use record
      ...
      OTG_HS_DIEPEACHMSK1 at 16#44# range 0 .. 31;
      OTG_HS_DOEPEACHMSK1 at 16#84# range 0 .. 31;
   ...
   type OTG_HS_HOST_Peripheral is record
      ...
      --  OTG_HS host channel-11 interrupt register
      OTG_HS_HCINT0     : aliased OTG_HS_HCINT0_Register;
      ...
      OTG_HS_HCINTMSK15 : aliased OTG_HS_HCINTMSK_Register;
